...
This contains:
- plotify.py, which contains functions to get nice circumpolar maps of the southern ocean. It pulls data from the two data folders, which are:
...
6/3/26: Updated plotify.py to be able to plot nice maps with a lambert conformal projection, nice for regional maps.
